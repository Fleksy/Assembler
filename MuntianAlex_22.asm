;Мунтян Александр, вариант 2. Сформировать массив B из элементов массива A, значение которых не совпадает с первым и последним элементами A.
format PE console
...
CreateArr2:   ;Формирование массива B из элементов A, значение которых не совпадает с первым и последним элементами A
        mov eax,[arrA]
        mov ebx,[eax]
        mov [first],ebx
        mov ebx,[lengthA]
